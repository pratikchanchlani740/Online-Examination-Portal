...
setIconImage(icon);
           ...
           if(rs.next())
           {
            ...
            while(rst2.next())
            {
                ...
                model.addRow(new Object[]{rst2.getInt("eid"),rst2.getString("cname"),rst2.getString("sname"),rst2.getString("date"),rst2.getInt("totalq"),rst2.getInt("studntexam.max"),rst2.getInt("dur"),rst2.getInt("pass")});
